...
public final class FaceTrackerActivity extends AppCompatActivity {
    ...
    private void requestStoragePermission() {
        Log.w(TAG, "Storgae permission is not granted. Requesting permission");
    ...
    private class postImg extends AsyncTask<Void, Void, Void> {
        private byte[] bytes;

        public postImg( byte[] bytes) {
            this.bytes = bytes;
        }
        ...
        protected Void doInBackground(Void... params) {
            try {
                String method = "POST";
                //URL url = new URL("http://47b60a7d.ngrok.io/face/detect");
                //URL url = new URL("https://1bfe7422.ngrok.io/face/detect");
                URL url = new URL("https://demagic.azurewebsites.net/face/detect");
                ...
                httpConn.setRequestProperty("Access-key", "conf2018");
